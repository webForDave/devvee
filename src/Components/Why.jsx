...
const Why = () => {
    ...
    let [reaseons, setReasons] = useState([
        ...
        {title: 'Without Impurities', body: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo voluptates sed quasi', id: 4},
        {title: 'Professional Roasting', body: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo voluptates sed quasi', id: 5},
        {title: 'Nice Pricing', body: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo voluptates sed quasi', id: 6}
    ]);
    ...
    return (
        <section className="w-full h-auto py-[10px] lg:py-[40px]">
            ...
            <div className="w-[90%] h-auto -700 mx-auto lg:flex justify-between items-center">
                ...
                <div>
                    <h1 className="font-[georgia] text-[32px] font-bold lg:text-[45px]">Why Choose Our Coffee???</h1>
                    ...
                    <div className="w-[100%] h-auto lg:grid grid-cols-2 gap-10">
                        {reaseons.map(reason => (
                            <div key={reason.id} className='flex justify-between items-center'>
                                ...
                                <div className="my-[10px] px-[20px] lg:my-0">
                                    <h1 className="text-[22px] font-bold font-[georgia]">{reason.title}</h1>
                                    <p className="w-[100%]">{reason.body}</p>
                                </div>
                            </div>
                        ))}
                    </div>
