        ...
        <section className="w-auto h-auto py-[50px] bg-[#100b08]">
            ...
            <div className="w-[90%] h-auto lg:flex justify-between items-center mx-auto">
                ...
                <div className="w-[100%] lg:w-[50%] h-auto">
                    ...
                    <form action="" className="w-[80%] h-auto tect-black">
                        <input type="text" placeholder='Name*' className="w-[40%] h-[50px] mr-[50px] px-[20px] bg-[#d3d3d3] rounded-[10px]" />
                        <input type='text' placeholder='Phone*' className="w-[40%] h-[50px] px-[20px] bg-[#d3d3d3] rounded-[10px]"/>
                        <textarea name="text" className="w-[100%] h-[100px] my-[20px] bg-[#d3d3d3] px-[20px] pt-[10px] rounded-[5px]" placeholder='Comment*'></textarea>
